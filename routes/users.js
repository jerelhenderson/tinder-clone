            ...
            if (email && password && fullname && age && gender) {
                ...
                dbConn.query(sql, [email], (err, result) => {
                    if (result && result.length !== 0) {
                        ...
                        const insertUser = "INSERT INTO user_account (user_email, user_password, user_full_name, user_age, user_avatar, user_gender, user_cometchat<uid) VALUES ?";
        ...
        if (users && users.length !== 0) {
            return users.map(user => {
                return {
                    ...
                    user_cometchat_uid: user.user_comentchat_uid,
